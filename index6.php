...
<body>
    <div class="container mt-5">
        ...
        <div class="mt-4">
            ...
            $price = 0; // variabel untuk menampung total harga

            echo "<ol class='list-group'>";

            //  
            foreach ($barang as $item) {
                $subPrice = $item['harga_barang'] * $item['jumlah_beli']; // menghitung subtotal per item
                ...
                $price += $subPrice; //untuk menghitung harga subtotal ke total harga
            }
            echo "</ol>";
